...
torchrun \
  --nproc_per_node=4 \
  -m dwm.train \
  -c /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM/configs/ctsd/unimlvg/camsim/nuplan/nuplantokentv_petr_full2.json\
  -o /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output/train_nuplanpetrtokentvfull2\
  --log-steps  500 \
  --preview-steps 1000 \
