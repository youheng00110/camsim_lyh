...
torchrun \
  --nproc_per_node=4 \
  -m dwm.train \
  -c //inspire/qb-ilm/project/wuliqifa/chenxinyan-240108120066/songbur-data/camsim_lyh/OpenDWM/configs/ctsd/unimlvg/camsim/explicit.json\
  -o /inspire/qb-ilm/project/wuliqifa/chenxinyan-240108120066/songbur-data/camsim_lyh/output/train_explicit\
  --log-steps 300 \
  --preview-steps 500 \
