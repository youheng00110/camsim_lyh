...
torchrun \
  ...
  --nproc_per_node=4 \
  -m dwm.preview \
  -c "/inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM/configs/ctsd/unimlvg/camsim/nuplan/preview4cam/nuplancamtokenpreview4cam.json" \
  -o "/inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output/debug_nuplancamtoken_4cam"
