...
torchrun \
  ...
  --nproc_per_node=4 \
  -m dwm.preview \
  -c "/inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM_PV/nuplan2hz/nuplanimplicit2hz.json" \
  -o "/inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output/debug_nuplanimplcit2hz"
